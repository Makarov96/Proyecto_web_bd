...
function errores(input) {
    ...
    for (var x = 0; x <= input.length; x++) {
        ...
        if (input[x] == "Int" || input[x] == "INt" || input[x] == "INT" ||
            ...
            data = "Error: 12 - Se escribio mal el switch error de tipo: lexico";
...
function informacion(data) {
    ...
    switch (data) {
        ...
        case "int":
            result = "1-Int-Variable Reservada - Tipo primitivo";
            break;
        case "short":
            result = "2-short-Variable Reservada - Tipo primitivo";
            break;
        case "byte":
            result = "3-byte-Variable Reservada - Tipo primitivo";
            break;
        case "long":
            result = "4-long-Variable Reservada - Tipo primitivo";
            break;
        case "boolean":
            result = "5-boolean-Variable Reservada - Tipo primitivo";
            break;
        case "char":
            result = "6-char-Variable Reservada - Tipo primitivo";
            break;
        case "float":
            result = "7-float-Variable Reservada - Tipo primitivo";
            break;
        case "double":
            result = "8-double-Variable Reservada - Tipo primitivo";
            break;
        case "String":
